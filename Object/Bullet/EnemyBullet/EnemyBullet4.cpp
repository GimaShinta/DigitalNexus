...
void EnemyBullet4::Update(float delta_second)
{
...
void EnemyBullet4::Draw(const Vector2D& screen_offset) const
{
...
void EnemyBullet4::SetWaveParameters(float amplitude, float frequency)
{
	wave_amplitude = amplitude;
	wave_frequency = frequency;
}

void EnemyBullet4::SetWaveReflected(bool reflected)
{
